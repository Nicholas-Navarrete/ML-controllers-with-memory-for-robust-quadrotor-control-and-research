...
class DroneController:
    ...
    def PID_control(self, x_pos, y_pos, z_pos, x_goal, y_goal, z_goal, Yaw, times):
        ...
        if thrust > 2.23346:
            ...
            thrust = 0
        thrust = thrust*(50000/2.23346) + 15001
    ...
    def _control_loop(self):
        ...
        #ThrustList for calculating average Thrust
        ThrustList=[]
        ...
        while self.control:
            ...
            print('\r' +"Roll: %5.2f\tPitch: %5.2f\tThrust: %5.2f" % (roll, pitch, thrust), end='')
        ...
        print("Average Thrust: ", np.mean(ThrustList))
        self._cf.commander.send_setpoint(0, 0, 0, 0)
        self._cf.close_link()
        print("Average Thrust: ", np.mean(ThrustList))
